...
module Noll.Kernel.LLVM.IREval.Expr (IREval (..)) where
...
import Noll.Kernel.LLVM.IREval.Expr.App (irEvalApp)
import Noll.Kernel.LLVM.IREval.Expr.Match (irEvalMatch)
import Noll.Kernel.LLVM.IREval.Expr.Op (irEvalOp)
import Noll.Kernel.LLVM.IREval.Expr.Var (irEvalVar)
import Noll.Kernel.LLVM.IRInstruction (ICmpCond (..))
