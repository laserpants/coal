...
module Noll.Compiler2.Lowpass.TranslateModule (translateModule) where

import Control.Monad.Reader (MonadReader)
import Data.Data (Data)
import Lang.Common.Environment
import Lang.Utils (Name)
import Noll.Compiler2.Lowpass.Environment (TranslateEnvironment, insertQualifiedNames, withModuleName)
