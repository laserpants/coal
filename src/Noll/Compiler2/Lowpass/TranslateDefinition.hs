...
module Noll.Compiler2.Lowpass.TranslateDefinition (translateDefinition) where
...
import Noll.Compiler2.Lowpass.Environment (TranslateEnvironment (..), withLocalNames)
import Noll.Compiler2.Lowpass.TranslateExpression (translateExpression, translatePattern)
import Noll.Compiler2.Lowpass.TranslateType (translateType)
