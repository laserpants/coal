...
module Noll.Compiler2.Lowpass.TranslateExpression (
  translateExpression,
  translatePattern,
) where
...
import Noll.Compiler2.Lowpass.Environment (TranslateEnvironment (..), qualifyName, withLocalName, withLocalNames)
