...
passMainEntrypointRule :: (MonadIO m) => Pass Metadata m [BuildUnit (ProtoModule Metadata () ())] [BuildUnit (ProtoModule Metadata () ())]
...
-- impl = traverse (withCurrentModuleC_ detectMainEntrypoint)
