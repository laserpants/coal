...
instance PatternExhaustiveCheckContext (Choice Expression Metadata k t) where
  patternExhaustiveCheck name =
    \case
      CPlain a gs e -> do
...
instance PatternExhaustiveCheckContext (Guard Expression Metadata k t) where
  patternExhaustiveCheck name =
    \case
      CGuard e ->
        patternExhaustiveCheck name e
...
instance PatternExhaustiveCheckContext (Clause Metadata k t) where
  patternExhaustiveCheck name =
    \case
      EClause a p cs ->
...
instance PatternExhaustiveCheckContext (Expression Metadata k t) where
  patternExhaustiveCheck name =
    \case
      EAnnotation a t e ->
        patternExhaustiveCheck name e
