...
collectDataConstructors :: (MonadIO m, Show a) => Environment (AliasEntry a) -> Environment Kind -> Definition a Kind () -> StateT (ModuleBuild a) (CompilerT a (ProtoCompilerT m a)) ()
