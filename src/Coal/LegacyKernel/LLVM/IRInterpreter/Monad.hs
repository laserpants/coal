...
import Coal.LegacyKernel.LLVM.IREncodable (IREncodable (..), enquote)
import Coal.LegacyKernel.LLVM.IRError (IRGenError)
import Coal.LegacyKernel.LLVM.IRInterpreter.Artifact (IRInterpreterArtifact)
import Coal.LegacyKernel.LLVM.IRInterpreter.Environment (IRInterpreterEnv)
