...
-}
module Coal.LegacyKernel.LLVM.IREval.Conceal (irConceal, irConcealArgs, irReveal) where
...
import Coal.LegacyKernel.LLVM.IRType.Syntax (i1, i32, i64, i8, i8Ptr, ptr)
