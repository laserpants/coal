...
module Coal.LegacyKernel.LLVM.IRInstruction.Builders (
  add,
  sub,
  mul,
  fadd,
...
import Coal.LegacyKernel.LLVM.IRInstruction (FCmpCond, ICmpCond, IRConstructor, IRInstr, IRInstrOp, InstrOpF (..), MetaOpF (..), TailMarker (..))
