...
module Coal.LegacyKernel.Compiler.Pass.ClosureConversion (closeObjects) where

import Coal.Common.FreeVars (freeSet)
import Coal.Common.Label (Label (..))
import Coal.LegacyKernel.Compiler.AST (flattenAppNodes)
import Coal.LegacyKernel.Language (Expr, Type)
import qualified Coal.LegacyKernel.Language as Syntax
import Coal.LegacyKernel.Language.Object (Object (..), ObjectList, objectName)
