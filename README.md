...
| ✅         | <strike>Bug: double precision</strike>                | 3          | Qualified (namespace) imports     | `import namespace X` works.                                                                           |                                                                         
