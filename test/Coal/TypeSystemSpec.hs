...
-- module Coal.TypeSystemSpec (spec) where
...
import Coal.Compiler.Transform.DictionariesSpec
import Coal.Compiler.Kernel.Environment (KernelEnvironment (..), initialKernelEnvironment, insertQualifiedNames, withModuleName)
import Coal.Compiler.Kernel.TranslateDefinition (translateDefinition)
import Coal.Compiler.Kernel.TranslateExpressionSpec
import Coal.Compiler.Kernel.TranslateModule (translateModule)
import Coal.Compiler.Transform.NormalizeObjects (NormalizeObjectsTransformContext (..), normalizeObject)
...
import Coal.CompilerSpec (compilerTestEnvironment)
import Coal.Language
import Coal.Language.Module (Constant (..), Function (..), Module (..))
import Coal.TypeSystem.Constraint.Assumption (Assumption (..))
import Coal.TypeSystem.Constraint.Generation.Internal (InferenceRule (..))
import Coal.TypeSystemSpec.TestRunner
import Test.Hspec (Spec, describe, it)

import qualified Data.Set as Set
import qualified Coal.Common.Environment as Environment
import qualified Coal.CompilerExamples.Test02
import qualified Coal.Set.Test01
import qualified Coal.Set.Test02
import qualified Coal.Set.Test03
import qualified Coal.Set.Test04
import qualified Coal.Set.Test05
import qualified Coal.Set.Test06
import qualified Coal.Set.Test07
import qualified Coal.Set.Test08
import qualified Coal.Set.Test09
import qualified Coal.Set.Test10
import qualified Coal.Set.Test11
import qualified Coal.Set.Test12
import qualified Coal.Set.Test13
import qualified Coal.Set10.Test01
import qualified Coal.Set10.Test03
import qualified Coal.Set10.Test04
import qualified Coal.Set2.Test05
import qualified Coal.Set2.Test09
import qualified Coal.Set2.Test10
import qualified Coal.Set2.Test12
import qualified Coal.Set3.Test04
import qualified Coal.Set3.Test05
import qualified Coal.Set3.Test10
import qualified Coal.Set3.Test10x
import qualified Coal.Set3.Test12
import qualified Coal.Set3.Test12x
import qualified Coal.Set3.Test13x
import qualified Coal.Set4.Test02
import qualified Coal.Set4.Test021
import qualified Coal.Set5.Test01
import qualified Coal.Set5.Test03
import qualified Coal.Set5.Test04
import qualified Coal.Set5.Test05
import qualified Coal.Set5.Test09
import qualified Coal.Set5.Test10
import qualified Coal.Set5.Test12
import qualified Coal.Set5.Test13
import qualified Coal.Set5.Test14
import qualified Coal.Set6.Test12
import qualified Coal.Set6.Test13

spec :: Spec
spec =
  describe "Coal.TypeSystem" $ do
...
-- baz =
--  Coal.TypeSystemSpec.typedExpression_
--    []
--    --      ( "not"
--    --      , Forall
--    --          mempty
...
story = do
  ...
  --  it "" $
  --    evalFoldExpansion "fold" 1 (compileFolds Coal.Set.Test02.prog1_02) == Coal.Set.Test03.prog1_03
  --  it "" $
  --    evalFoldExpansion "fold" 1 (compileFolds Coal.Set5.Test01.prog1_01) == Coal.Set5.Test03.prog1_03
  --  --  it "" $
  --  --    evalFoldExpansion "fold" 1 (compileFolds Coal.Set10.Test01.prog10_01) == Coal.Set10.Test03.prog10_01
  --  it "" $
  --    testResultExpression (Coal.CompilerExamples.Test02.baz3 Coal.Set.Test03.moduleUtils) == Coal.Set.Test04.moduleUtils
  --  it "" $
  --    testResultExpression (Coal.CompilerExamples.Test02.baz3 Coal.Set.Test03.moduleOrdered) == Coal.Set.Test04.moduleOrdered
  --  it "" $
  --    testResultExpression (Coal.CompilerExamples.Test02.baz3 Coal.Set.Test03.moduleBinarySearch) == Coal.Set.Test04.moduleBinarySearch
  --  it "" $
  --    testResultExpression (Coal.CompilerExamples.Test02.baz3 Coal.Set.Test03.moduleMain) == Coal.Set.Test04.moduleMain
  --  it "" $
  --    testResultExpression (Coal.CompilerExamples.Test02.baz3 Coal.Set5.Test03.moduleMain) == Coal.Set5.Test04.moduleMain
  --  it "" $
  --    normalizeObject Coal.Set.Test04.prog1_04 == Coal.Set.Test05.prog1_05
  --  it "" $
  --    normalizeObject Coal.Set3.Test04.prog3_04 == Coal.Set3.Test05.prog3_05
  --  it "" $
  --    normalizeObject Coal.Set5.Test04.prog1_04 == Coal.Set5.Test05.prog1_05
  --  it "" $
  --    evalPatternDesugar "v" 0 (desugarPatterns Coal.Set.Test05.moduleBinarySearch) == Coal.Set.Test06.moduleBinarySearch
  --  it "" $
  --    evalPatternDesugar "v" 0 (desugarPatterns Coal.Set.Test05.moduleOrdered) == Coal.Set.Test06.moduleOrdered
  --  it "" $
  --    evalPatternDesugar "v" 0 (desugarPatterns Coal.Set.Test05.moduleMain) == Coal.Set.Test06.moduleMain
  --  it "" $
  --    runIdentity (Coal.Compiler.Transform.Pattern.OrExpansion.compileOrPatterns Coal.Set.Test06.moduleUtils) == Coal.Set.Test07.moduleUtils
  --  it "" $
  --    runIdentity (Coal.Compiler.Transform.Pattern.OrExpansion.compileOrPatterns Coal.Set.Test06.moduleOrdered) == Coal.Set.Test07.moduleOrdered
  --  it "" $
  --    runIdentity (Coal.Compiler.Transform.Pattern.OrExpansion.compileOrPatterns Coal.Set.Test06.moduleBinarySearch) == Coal.Set.Test07.moduleBinarySearch
  --  it "" $
  --    runIdentity (Coal.Compiler.Transform.Pattern.OrExpansion.compileOrPatterns Coal.Set.Test06.moduleMain) == Coal.Set.Test07.moduleMain
  --  it "" $
  --    fst (runExpandRecordPatterns (compileRecordPatterns Coal.Set.Test07.moduleUtils) "row" 1) == Coal.Set.Test08.moduleUtils
  --  it "" $
  --    fst (runExpandRecordPatterns (compileRecordPatterns Coal.Set.Test07.moduleOrdered) "row" 1) == Coal.Set.Test08.moduleOrdered
  --  it "" $
  --    fst (runExpandRecordPatterns (compileRecordPatterns Coal.Set.Test07.moduleBinarySearch) "row" 1) == Coal.Set.Test08.moduleBinarySearch
  --  it "" $
  --    fst (runExpandRecordPatterns (compileRecordPatterns Coal.Set.Test07.moduleMain) "row" 1) == Coal.Set.Test08.moduleMain
  --  it "" $
  --    evalMatchMonad "match" 0 (compileMatchExprs Coal.Set.Test08.prog1_08) == Coal.Set.Test09.prog1_09
  --  it "" $
  --    evalMatchMonad "match" 0 (compileMatchExprs Coal.Set2.Test05.prog2_05) == Coal.Set2.Test09.prog2_09
  --  it "" $
  --    evalMatchMonad "match" 0 (compileMatchExprs Coal.Set5.Test05.moduleMain) == Coal.Set5.Test09.moduleMain
  --  it "" $
  --    fst (runIdentity (runCompilerT compilerTestEnvironment (typePass Coal.Set.Test01.moduleMain2))) == Coal.Set.Test04.moduleMain
  --  it "" $
  --    desugarAsPatterns Coal.Set10.Test03.prog10_01 == Coal.Set10.Test04.prog10_01
  --
  --  --  it "" $
  ...
  --  --  it "" $
  --  --    runTraitTransformZ testEnvZ2 (transformModuleZ Coal.Set.Test09.moduleUtils) (freshIdIn Coal.Set.Test09.moduleUtils) == Coal.Set.Test10.moduleUtils
  --  --  it "" $
  --  --    runTraitTransformZ testEnvZ2 (transformModuleZ Coal.Set.Test09.moduleOrdered) (freshIdIn Coal.Set.Test09.moduleOrdered) == Coal.Set.Test10.moduleOrdered
  --  --  it "" $
  --  --    runTraitTransformZ testEnvZ2 (transformModuleZ Coal.Set.Test09.moduleBinarySearch) (freshIdIn Coal.Set.Test09.moduleBinarySearch) == Coal.Set.Test10.moduleBinarySearch
  --  --  it "" $
  --  --    runTraitTransformZ testEnvZ2 (transformModuleZ Coal.Set.Test09.moduleMain) (freshIdIn Coal.Set.Test09.moduleMain) == Coal.Set.Test10.moduleMain
  --  --  it "" $
  ...
  --  it "" $
  --    -- TODO
  --    True -- eliminateDictionaries Coal.Set.Test10.moduleUtils == Coal.Set.Test11.moduleUtils
  --  it "" $
  --    -- TODO
  --    True -- eliminateDictionaries Coal.Set.Test10.moduleOrdered == Coal.Set.Test11.moduleOrdered
  --  it "" $
  --    -- TODO
  --    True -- eliminateDictionaries Coal.Set.Test10.moduleBinarySearch == Coal.Set.Test11.moduleBinarySearch
  --  it "" $
  --    -- TODO
  --    True -- eliminateDictionaries Coal.Set.Test10.moduleMain == Coal.Set.Test11.moduleMain
  --  it "" $
  --    denormalizeObject Coal.Set.Test11.prog1_11 == Coal.Set.Test12.prog1_12
  --  it "" $
  --    denormalizeObject Coal.Set2.Test10.prog2_10 == Coal.Set2.Test12.prog2_12
  --  it "" $
  --    denormalizeObject Coal.Set3.Test10.prog3_10 == Coal.Set3.Test12.prog3_12
  --  it "" $
  --    denormalizeObject Coal.Set3.Test10x.prog3_10x == Coal.Set3.Test12x.prog3_12x
  --  it "" $
  --    denormalizeObject Coal.Set5.Test10.prog1_10 == Coal.Set5.Test12.prog1_12
  it "" $
...
--  it "" $
--    runReader (traverse translateModule Coal.Set.Test12.prog1_12) testNameEnvironment == Coal.Set.Test13.prog1_13
--  it "" $
--    runReader (traverse translateModule Coal.Set3.Test12x.prog3_12x) testNameEnvironment == Coal.Set3.Test13x.prog3_13x
--  it "" $
--    runReader (traverse translateModule Coal.Set5.Test13.prog1_13) testNameEnvironment == Coal.Set5.Test14.prog4_14
--  it "" $
--    fixturee3 == fixturee2
--  it "" $
--    fixturee6 == fixturee5
...
--  it "" $
--    runTraitTransformY2 (freshIdIn Coal.Set.Test09.moduleUtils) (expandTraits Coal.Set.Test09.moduleUtils) == Coal.Set.Test10.moduleUtils
--  it "" $
--    runTraitTransformY2 (freshIdIn Coal.Set.Test09.moduleOrdered) (expandTraits Coal.Set.Test09.moduleOrdered) == Coal.Set.Test10.moduleOrdered
--  it "" $
--    runTraitTransformY2 (freshIdIn Coal.Set.Test09.moduleBinarySearch) (expandTraits Coal.Set.Test09.moduleBinarySearch) == Coal.Set.Test10.moduleBinarySearch
--  it "" $
--    runTraitTransformY2 (freshIdIn Coal.Set.Test09.moduleMain) (expandTraits Coal.Set.Test09.moduleMain) == Coal.Set.Test10.moduleMain
--  it "" $
--    runTraitTransformY2 (freshIdIn Coal.Set5.Test09.moduleMain) (expandTraits Coal.Set5.Test09.moduleMain) == Coal.Set5.Test10.moduleMain
--  it "" $
--    evalUnfoldExpansion "unfold" 1 (compileUnfolds Coal.Set4.Test02.moduleMain) == Coal.Set4.Test021.moduleMain
--  it "" $
--    evalNatExpansion "succ" 1 (compileNats Coal.Set6.Test12.moduleMain) == Coal.Set6.Test13.moduleMain
