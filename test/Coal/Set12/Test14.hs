...
module Coal.Set12.Test14 where
...
moduleUtilities1 :: Module Kernel.Type Name (Kernel.Expr Kernel.Type)
moduleUtilities1 = unsafeParseExpr <$> moduleUtilities

moduleUtilities :: Module Kernel.Type Name Text
moduleUtilities =
  Module
...
kloobx :: IO ()
kloobx = Kernel.testModules =<< Kernel.compileModules fixture3
