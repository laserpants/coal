...
import Coal.Language.HasType (foldTypeOf)
import Coal.Language.Type.Indexed (indexed)
import Coal.Language.Module (Constant (..), Definition (..), Function (..), definitionName)
import Coal.TypeSystem
import Coal.TypeSystem.Substitution (mapsTo)
