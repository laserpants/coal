...
moduleFoo1 :: Module Kernel.Type Name (Kernel.Expr Kernel.Type)
moduleFoo1 = unsafeParseExpr <$> moduleFoo

moduleFoo :: Module Kernel.Type Name Text
moduleFoo =
  Module
    { moduleName = "Foo"
    , moduleImports =
...
mooz :: IO ()
mooz = Kernel.testModules =<< Kernel.compileModules fixture3
