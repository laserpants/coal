...
module Coal.CompilerExamples.Test02 where
...
import qualified Coal.Examples.Test03 as Test03
...
spec =
  describe "Coal.Compiler" $ do
    ...
    --    it "" $ do
    --      testResultExpression (baz3 Coal.Set.Test03.moduleUtils) == Coal.Set.Test04.moduleUtils
    --    it "" $ do
    --      testResultExpression (baz3 Coal.Set.Test03.moduleOrdered) == Coal.Set.Test04.moduleOrdered
    --    it "" $ do
    --      testResultExpression (baz3 Coal.Set.Test03.moduleBinarySearch) == Coal.Set.Test04.moduleBinarySearch
    --    it "" $ do
    --      testResultExpression (baz3 Coal.Set.Test03.moduleMain) == Coal.Set.Test04.moduleMain
    it "" $ do
      testResultExpression (Coal.CompilerExamples.Test02.baz Coal.CompilerExamples.Test02.fixture4) == Coal.CompilerExamples.Test02.fixture41
    it "" $ do
      testResultExpression (Coal.CompilerExamples.Test02.baz Coal.CompilerExamples.Test02.fixture5) == Coal.CompilerExamples.Test02.fixture51
