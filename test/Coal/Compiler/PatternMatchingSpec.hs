...
module Coal.Compiler.PatternMatchingSpec where
...
-- import Coal.Compiler.PatternMatchingSpec.TestRunner (compilePatterns)
-- import Coal.Eval (Value (..), eval)
-- import Coal.Examples.Test07 (test07)
-- import Coal.Examples.Test08 (test08)
-- import Coal.Language (CompiledClause (..), Expression (..), Pattern (..), Primitive (..), With (..))
