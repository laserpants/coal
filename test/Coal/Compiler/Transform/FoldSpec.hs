...
module Coal.Compiler.Transform.FoldSpec where

import Coal.Common.List1 (List1 (..), NonEmpty (..), (<|))
import Coal.Common.Label (Label (..))
import Coal.Compiler.Transform.Fold
import Coal.Examples.Test02 (test02)
import Coal.Examples.Test03 (test03)
import Coal.Language (BinaryOperator (..), Binding (..), Choice (..), Clause (..), Expression (..), Pattern (..), Primitive (..))
import Test.Hspec (Spec, describe, it)

import qualified Data.Map.Strict as Map
import qualified Coal.Examples.Test02 as Test02
...
spec :: Spec
spec =
  describe "Coal.Compiler.Transform.Fold" $ do
    describe "" $ do
      it "" $ do
