...
e2eSpec = do
  ...
  describe "159" $ do
    it "is PreflightFailure" $ do
      res <-
        runSpec
          [ "./test/Coal/examples/159/Hello.coal"
          , "./test/Coal/examples/159/Main.coal"
          ]
      res `shouldBe` Left PreflightFailure
  ...
  describe "166" $ do
    expectOutput
      "42"
      [ "./test/Coal/examples/166/Main.coal"
      ]

  describe "167" $ do
    expectOutput
      "42"
      [ "./test/Coal/examples/167/Main.coal"
      ]

  describe "169" $ do
    expectOutput
      "-3.000000"
      [ "./test/Coal/examples/169/Main.coal"
      ]

  describe "172" $ do
    expectOutput
      "5.000000000000000"
      [ "./test/Coal/examples/172/Main.coal"
      ]
  ...
  describe "175" $ do
    expectOutput
      "10"
      [ "./test/Coal/examples/175/Main.coal"
      ]
  ...
  describe "179" $ do
    expectOutput
      "aaa"
      [ "./test/Coal/examples/179/Main.coal"
      ]

  describe "180" $ do
    expectOutput
      "abc"
      [ "./test/Coal/examples/180/Main.coal"
      ]

  describe "181" $ do
    expectOutput
      "4"
      [ "./test/Coal/examples/181/Main.coal"
      ]

  describe "182" $ do
    expectOutput
      "224"
      [ "./test/Coal/examples/182/Main.coal"
      ]

  describe "183" $ do
    expectOutput
      "-5"
      [ "./test/Coal/examples/183/Main.coal"
      ]
  ...
  describe "184" $ do
    it "is PreflightFailure" $ do
      res <-
        runSpec
          [ "./test/Coal/examples/184/Main.coal"
          ]
      res `shouldBe` Left PreflightFailure
  ...
  describe "185" $ do
    it "is PreflightFailure" $ do
      res <-
        runSpec
          [ "./test/Coal/examples/185/Main.coal"
          ]
      res `shouldBe` Left PreflightFailure
  ...
  describe "186" $ do
    expectOutput
      "true"
      [ "./test/Coal/examples/186/Main.coal"
      ]
