...
e2eSpec = do
  ...
  describe "400" $ do
    expectOutput
      "5456"
      "test/Coal/examples/400"
      ["Main.coal"]

  describe "401" $ do
    expectOutput
      "55555555555555555555555555555555555555"
      "test/Coal/examples/401"
      ["Main.coal"]

  describe "402" $ do
    expectOutput
      "55"
      "test/Coal/examples/402"
      ["Main.coal", "Foo.coal", "Pretty.coal"]

  describe "403" $
    expectOutput
      "abc"
      "test/Coal/examples/403"
      ["Main.coal"]

  describe "404" $
    expectOutput
      "hello"
      "test/Coal/examples/404"
      ["Main.coal"]

  describe "405" $
    expectOutput
      "123"
      "test/Coal/examples/405"
      ["Main.coal"]

  describe "406" $
    expectOutput
      "234"
      "test/Coal/examples/406"
      ["Main.coal"]

  describe "407" $
    expectOutput
      "6"
      "test/Coal/examples/407"
      ["Main.coal"]

  describe "409" $
    expectOutput
      "equal"
      "test/Coal/examples/409"
      [ "Helpers.coal"
      , "Main.coal"
      ]
  ...
  describe "420" $ do
    it "is PatternAnomaly" $ do
      res <- runSpec "test/Coal/examples/420" ["Main.coal"]
      res `shouldBe` Left PatternAnomaly

  describe "422" $
    expectOutput
      "truefalsefalsefalsetruefalse"
      "test/Coal/examples/422"
      [ "Main.coal"
      ]
