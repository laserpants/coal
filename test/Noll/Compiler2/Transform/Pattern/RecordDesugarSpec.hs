...
module Noll.Compiler2.Transform.Pattern.RecordDesugarSpec where
...
foo1235 :: (Expression () (Type TypeIndex Kind), [(Name, Dictionary (TypedPattern ()), Maybe (TypedPattern ()))])
foo1235 = runExpandRecordPatterns (expandRecordPatterns fixtr3) "row" 1
