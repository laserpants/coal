                ...
                ( EApplication
                    ...
                    ( EApplication
                        ...
                        ( EApplication
                            ...
                            ( EApplication
                                ()
                                (TIntrinsic IInt32 `TArrow` TConstructor KType "$Nat")
                                (EVariable () (Label (TApplication KTrait (TConstructor (KArrow KType KTrait) "Numeric") (TConstructor KType "$Nat" :| []) `TArrow` TIntrinsic IInt32 `TArrow` TConstructor KType "$Nat") "from_int32"))
                                ( ERecord
                                    ()
                                    (TApplication KTrait (TConstructor (KArrow KType KTrait) "Numeric") (TConstructor KType "$Nat" :| []))
                                    ( Map.fromList
                                        [
                                          ( "from_int32"
                                          , EVariable () (Label{labelTag = TArrow (TIntrinsic IInt32) (TConstructor KType "$Nat"), labelName = "from_int32__$instance.a952655fec712ed8"})
                                          )
                                        ]
                                    )
                                    Nothing
