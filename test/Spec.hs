...
main134 :: IO (Either CompilerFailureMode Text)
main134 = do
  runTestFiles
...
main136 :: IO (Either CompilerFailureMode Text)
main136 = do
  runTestFiles
...
main140 :: IO (Either CompilerFailureMode Text)
main140 = do
  runTestFiles
    [ "./test/Coal/examples/140/Main.coal"
    ]

main141 :: IO (Either CompilerFailureMode Text)
main141 = do
  runTestFiles
