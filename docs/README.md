...
The fact that this is an initial object means that there is a unique function ℎ : 𝜇𝐹 → 𝐴 that makes the diagram commute.
...
<p><img src="../.readme/tex/png/unfold.png" /></p>
